function b = computeTotalBiomass(result,model)
% computeTotalBiomass computes the total biomass accumulation at each
% timepoint given a deFBA solution
%
%INPUTS
% result            deFBA solution vector
...
%
%OUTPUT
% b         vector containing total biomass at each time point
% 
